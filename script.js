document.getElementById("Concatenate").onclick=function(){
    ...
    let num2 = "20"
    let sum = num1 + num2 ;
    document.getElementById("Statement").innerHTML='"5" + "10" '
 ...
 document.getElementById("ifnested").onclick=function(){
     ...
     if(userName==="nomanghaffar"){
         ...
         document.getElementById("output").innerHTML="Wrong userNAme <br> Correct user name is Abdullah786"
     }
 }
 ...
 document.getElementById("login").onclick = function(){
     ...
     if(Username ==="Noman"){
         if(Password==="pakistan123"){
             ...
             document.getElementById("output").innerHTML="incorrect password or username <br> use Noman as username or pakistan as password "
         }
     }
     else{
